  ...
  return (
    ...
    >
      ...
      <View>
        ...
        <UserInfoView item={selectedUserData.demographics} ETA={selectedUserData.ETA}/>
        <ContractHistory items={selectedUserData.contractHistory} />
        <ContractExecution />
      </View>
    </BottomSheet>
  );
    ...
    <View style={{ marginTop: 18 }}>
      ...
      <View style={styles.cardContent}>
        <View style={styles.contentList}>
          <Text style={styles.awayText}>{props.ETA}</Text>
        </View>
      </View>
    </View>
  );
...
const ContractHistory = (props) => {
  return (
    <View>
      <Card>
        <View>
          <View style={contractStyles.contentList}>
            <View>
              <Text>{props.items[0].name}</Text>
            </View>
            <View>
              <Text>{props.items[0].charged}</Text>
            </View>
          </View>
          <View style={{ flexDirection: "row", justifyContent: "flex-end" }}>
            <Text>{props.items[0].date}</Text>
          </View>
        </View>
      </Card>
      <Card>
        <View>
          <View style={contractStyles.contentList}>
            <View>
              <Text>{props.items[1].name}</Text>
            </View>
            <View>
              <Text>{props.items[1].charged}</Text>
            </View>
          </View>
          <View style={{ flexDirection: "row", justifyContent: "flex-end" }}>
            <Text>{props.items[1].date}</Text>
          </View>
        </View>
      </Card>
    </View>
...
const ContractExecution = (props) => {
  return <Text h5> contracts will be executed from here</Text>;
};
